...
// const API = axios.create({baseURL : "https://youtube-clone-ezgw.onrender.com/"})
...
export const deleteWatchLater = (videoId,Viewer)=>API.delete(`/video/deleteWatchLaters/${videoId}/${Viewer}`)
