...
export default function VideoUpload({setVidUploadPage}) {
  ...
  return (
    ...
    <div className="container_vidupload">
        ...
        onClick={()=>setVidUploadPage(false)} className='ibtn_x' />

        <div className="container2_vidupload">

            <div className="ibox_div_vidupload">
                <input onChange = {(e)=>{settitle(e.target.value)}} type="text" className='ibox_vidupload'
                    maxLength={30} placeholder='Enter Title of your Video' />
